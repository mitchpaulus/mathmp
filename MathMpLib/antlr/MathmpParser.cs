...
public partial class MathmpParser : Parser {
	...
	public FileContext file() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 25122110L) != 0)) {
				{
				{
				State = 25;
				math();
	...
	public MathContext math() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 25122104L) != 0)) {
				{
				{
				State = 39;
				expression(0);
	...
	private static int[] _serializedATN = {
		...
		1,7,0,1,4,8,0,2,4,6,8,10,12,14,0,2,1,0,18,20,1,0,4,5,133,0,22,1,0,0,0,
		2,42,1,0,0,0,4,81,1,0,0,0,6,100,1,0,0,0,8,104,1,0,0,0,10,106,1,0,0,0,12,
		109,1,0,0,0,14,113,1,0,0,0,16,18,5,1,0,0,17,16,1,0,0,0,17,18,1,0,0,0,18,
		19,1,0,0,0,19,21,5,2,0,0,20,17,1,0,0,0,21,24,1,0,0,0,22,20,1,0,0,0,22,
		23,1,0,0,0,23,36,1,0,0,0,24,22,1,0,0,0,25,30,3,2,1,0,26,28,5,1,0,0,27,
		26,1,0,0,0,27,28,1,0,0,0,28,29,1,0,0,0,29,31,5,2,0,0,30,27,1,0,0,0,31,
		32,1,0,0,0,32,30,1,0,0,0,32,33,1,0,0,0,33,35,1,0,0,0,34,25,1,0,0,0,35,
		38,1,0,0,0,36,34,1,0,0,0,36,37,1,0,0,0,37,1,1,0,0,0,38,36,1,0,0,0,39,41,
		3,4,2,0,40,39,1,0,0,0,41,44,1,0,0,0,42,40,1,0,0,0,42,43,1,0,0,0,43,3,1,
		0,0,0,44,42,1,0,0,0,45,46,6,2,-1,0,46,50,5,12,0,0,47,49,3,4,2,0,48,47,
		1,0,0,0,49,52,1,0,0,0,50,48,1,0,0,0,50,51,1,0,0,0,51,53,1,0,0,0,52,50,
		1,0,0,0,53,82,5,13,0,0,54,58,5,8,0,0,55,57,3,4,2,0,56,55,1,0,0,0,57,60,
		1,0,0,0,58,56,1,0,0,0,58,59,1,0,0,0,59,61,1,0,0,0,60,58,1,0,0,0,61,82,
		5,9,0,0,62,66,5,10,0,0,63,65,3,4,2,0,64,63,1,0,0,0,65,68,1,0,0,0,66,64,
		1,0,0,0,66,67,1,0,0,0,67,69,1,0,0,0,68,66,1,0,0,0,69,82,5,11,0,0,70,71,
		7,0,0,0,71,82,3,4,2,13,72,73,5,21,0,0,73,82,3,4,2,8,74,82,3,6,3,0,75,82,
		3,14,7,0,76,82,5,17,0,0,77,82,5,16,0,0,78,82,3,8,4,0,79,82,3,10,5,0,80,
		82,3,12,6,0,81,45,1,0,0,0,81,54,1,0,0,0,81,62,1,0,0,0,81,70,1,0,0,0,81,
		72,1,0,0,0,81,74,1,0,0,0,81,75,1,0,0,0,81,76,1,0,0,0,81,77,1,0,0,0,81,
		78,1,0,0,0,81,79,1,0,0,0,81,80,1,0,0,0,82,96,1,0,0,0,83,84,10,11,0,0,84,
		85,5,23,0,0,85,95,3,4,2,12,86,87,10,10,0,0,87,88,5,7,0,0,88,95,3,4,2,11,
		89,90,10,9,0,0,90,91,5,15,0,0,91,95,3,4,2,10,92,93,10,12,0,0,93,95,5,6,
		0,0,94,83,1,0,0,0,94,86,1,0,0,0,94,89,1,0,0,0,94,92,1,0,0,0,95,98,1,0,
		0,0,96,94,1,0,0,0,96,97,1,0,0,0,97,5,1,0,0,0,98,96,1,0,0,0,99,101,5,14,
		0,0,100,99,1,0,0,0,101,102,1,0,0,0,102,100,1,0,0,0,102,103,1,0,0,0,103,
		7,1,0,0,0,104,105,5,22,0,0,105,9,1,0,0,0,106,107,5,24,0,0,107,11,1,0,0,
		0,108,110,5,3,0,0,109,108,1,0,0,0,110,111,1,0,0,0,111,109,1,0,0,0,111,
		112,1,0,0,0,112,13,1,0,0,0,113,114,7,1,0,0,114,15,1,0,0,0,14,17,22,27,
		32,36,42,50,58,66,81,94,96,102,111
	};
